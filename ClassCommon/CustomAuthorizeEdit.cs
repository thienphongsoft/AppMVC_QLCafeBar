...
{
    public class CustomAuthorizeEdit : AuthorizeAttribute
    {
        private MyDB db = new MyDB();
        public string RoleID { set; get; }
        public bool QuyenSua { set; get; }
        protected override bool AuthorizeCore(HttpContextBase httpContext)
        {
            ...
            var validateName = db.AccessRightCF.FirstOrDefault(x => x.QuyenID == this.RoleID && x.TaiKhoan == userid.ToString() && x.Sua == this.QuyenSua);
